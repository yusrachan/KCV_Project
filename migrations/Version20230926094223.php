 ...
 */
final class Version20230926094223 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rendez_vous (id INT AUTO_INCREMENT NOT NULL, kinesitherapeute_id INT NOT NULL, date_heure_debut DATETIME NOT NULL, email VARCHAR(255) NOT NULL, INDEX IDX_65E8AA0A3B67E217 (kinesitherapeute_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
