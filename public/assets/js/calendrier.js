...
document.addEventListener("DOMContentLoaded", function () {
    ...
    .then(function (response) {
        // Traitement des données du calendrier
        let evenementsJSON = response.data; // Obtenez les données JSON du contrôleur

        // Initialisez votre calendrier avec evenementsJSON
        calendar.removeAllEvents();
        calendar.addEventSource(evenementsJSON);
    })
